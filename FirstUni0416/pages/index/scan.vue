...
<script>
	...
	export default {
		...
		methods: {
			...
			getList(number) {
							uni.request({
							  url: 'https://www.mxnzp.com/api/barcode/goods/details?barcode='+number, 
							  method:'GET',
							  header:{
								  app_id:'krcnnjkikoagrdnh',
								  app_secret:'ZFV6TytlZDZnSFRUWXpub2cyRHNOUT09',
										},
								success: (res) => {
			...
			createBarcode(currentWebview) {
				// 创建扫码识别控件对象
				barcode = plus.barcode.create('barcode', [plus.barcode.EAN13], {
					top: '0',
					left: '0',
					width: '100%',
					height: '100%',
