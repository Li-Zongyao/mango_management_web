	...
	<view class="wrap">
		<u-form :model="model" ref="uForm" :errorType="errorType">
			...
			<u-form-item :label-position="labelPosition" label="sellerID" prop="sellerID" label-width="150">
				<u-input :border="border" placeholder="请输入SellerID" v-model="model.sellerID" type="text"></u-input>
			</u-form-item>
			
			<u-form-item  label-width="180" :label-position="labelPosition" label="amount" prop="amount">
				<u-input :border="border" placeholder="请输入amount" v-model="model.amount" type="text"></u-input>
			</u-form-item>
			
			<u-form-item :label-position="labelPosition" label="unit" prop="unit" label-width="150">
				<u-input :border="border" placeholder="请输入unit" v-model="model.unit" type="text"></u-input>
			</u-form-item>
			
			<u-form-item :label-position="labelPosition" label="price" prop="price" label-width="150">
				<u-input :border="border" placeholder="请输入 price" v-model="model.price" type="text"></u-input>
			</u-form-item>
